...
public class NeoFactories_Block {
...
//木材系ブロック
    ...
    public static final DeferredBlock<StairBlock> SOLICA_STAIRS = registerBlock("solica_stairs", () -> new StairBlock(NeoFactories_Block.SOLICA_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.of().strength(2f)));
    ...
    private static <T extends Block> void registerBlockItem(String name, DeferredBlock<T> block) {
        NeoFactories_Item.ITEMS.register(name, () -> new BlockItem(block.get(), new Item.Properties()));
    }
